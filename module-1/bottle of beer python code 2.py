...
# While the number of bottles is greater than 0, the program will print the current number of bottles and decrement the count by 1.
        user_bottles -= 1
# bottle number is decremented by 1 each time the loop runs, and the program will continue to print the current number of bottles until it reaches 0.
        if user_bottles == 0:
...
# The countdown function is called with the user input, and the program will continue to run until the number of bottles reaches 0. Each iteration of the loop will print the current number of bottles and decrement the count by 1.